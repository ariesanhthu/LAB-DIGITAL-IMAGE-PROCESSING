...
\newcommand{\reportname}{Lab 6.1: PyTorch - Images Input \& Visualization - Version \#1}
...
\setlength{\cftbeforelottitleskip}{5em}   % trước title
\setlength{\cftafterlottitleskip}{2em}      % sau title
% ============ DOCUMENT ============
\begin{document}

...
The network employs two distinct activation functions: Rectified Linear Unit (ReLU) for the hidden layer~\cite{gfg_relu_activation} and Softmax for the output layer~\cite{sefiks_softmax_activation}. Each function serves a specific purpose in the network's computational pipeline.
...
\begin{figure}[H]
    ...
    \caption{Softmax example. \cite{sefiks_softmax_activation}}
...
\begin{figure}[H]
    ...
    \caption{Softmax architecture. \cite{tds_mlp_handwritten_digits}}
